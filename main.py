...
class MediMapProApp(MDApp):
    ...
    def build(self):
        ...
        if self._startup_presplash is not None:
            ...
            Clock.schedule_once(self._start_presplash_fade, 0.45)
    ...
    def _build_startup_presplash(self):
        ...
        surface = palette.get("surface", (0.028, 0.052, 0.110, 0.992))
        ...
        with overlay.canvas.before:
            ...
            overlay._glow_color = Color(accent[0], accent[1], accent[2], 0.08)
        ...
        with center.canvas.before:
            ...
            center._bg_color = Color(*surface)
            ...
            center._border_color = Color(*border)
    ...
    def _start_presplash_fade(self, *_):
        ...
        try:
            ...
            pass
        anim = Animation(opacity=0, duration=0.90, t="out_quad")
